users: list = [
    ...
    {'username': 'paweł', 'location': 'Sopot', 'posts': 2,
     'usermessage': ['życzenia2', 'kocham legie1', 'sprzedam opla1']},
    {'username': 'eliza', 'location': 'Toruń', 'posts': 3, 'usermessage': ['życzenia3', 'kocham legie2']},
    {'username': 'filip', 'location': 'Szczecin', 'posts': 4,
